        ...
        <div className="about-sections">
            ...
            <div className="about-right">
                <div className="about-para">
                    ...
                    <p>Currently pursuing my Bachelor's degree in <p1>Computer Science and Engineering</p1> with a specialization in <span>Artificial Intelligence and Machine Learning</span> at <p1>SRM Institute of Science and Technology, Kattankulathur, Chennai.</p1></p>
                    <p>Completed my schooling at <p1>RN Podar, Mumbai</p1> with an outstanding <span>90.6%</span> in 12th grade.</p>
